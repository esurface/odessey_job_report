...
#
# usage: [SACCT_ARGS=args] job_report.sh [--dir=job_dir] [--verbose] [sacct_args]"
#
# args:
# To generate a report on specific jobs, add arguments for /usr/bin/sacct by defining
#  SACCT_ARGS as an env variable or by passing arguments inline
# job_dir should be the directory containing the .err and .out files generated by SLURM
# Turn on the --verbose flag to see more information on failed runs

usage() {	
	echo "usage: [SACCT_ARGS=args] job_report.sh [--dir=job_dir] [--verbose] [sacct_args]"
}
